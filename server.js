...
app.post('/createEvent', async(req,res) => {
  ...
  const urlParams = 'token=' + 'api1596136832JQFeMLgszSiaZ9NdO0T592473' + '&calendar_id=' + '1616487337329865' + '&title=' + title + '&description=' + _description + '&location=' + location + '&organizer=' + organizer + '&organizer_email=' + organizer_email + '&reminder=' + '20' + '&start_date=' + start_date + '&end_date=' +parsed_date_time + 60*60000;
